    ...
    <section className='statistic'>
      ...
      <div className='statistic__cards'>
        <div className='statistic__card'>
          <h4 className='statistic__number'>Реализовали <br/>1000+ часов аутстаффинга</h4>
        ...
        <div className='statistic__card'>
          <h4 className='statistic__number'>Разобрали <br/>50+ кейсов падения производительности</h4>
        ...
        <div className='statistic__card'>
          <h4 className='statistic__number'>Осуществили <br/>10+ внедрений</h4>
