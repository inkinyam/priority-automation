      ...
      <ul className='works__cardlist'>
        <li className='works__card'>
          <div className='works__card-info'>
            <h4 className='works__card-title'>Мобильное приложение для склада.</h4>
            <p className='works__card-description'>
            ...
            <p className='works__about'>Приложение позволяет сотрудникам склада выполнять рутинные действия при помощи мобильного устройства: сборка накладых на отгрузку, прием поступлений, инвентаризации. 
            ...
            <Link to='/contact' className='works__more'>Узнать подробнее</Link>
          </div>
        ...
        <li className='works__card'>
          <div className='works__card-info'>
            <h4 className='works__card-title'>Интеграционная шина данных.</h4>
            <p className='works__card-description'>
            ...
            <p className='works__about'>Интеграционная шина является решением на стыке идей конвертации данных и шины данных(ESB). Оно позволяет уйти от ряда недостатков конвертации и одновременно использует основные
